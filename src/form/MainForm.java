...
//        setExtendedState(JFrame.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        jMenuItemCurrentUser.setText("Current user");
        ...
        jMenuItemServerConfiguration.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemServerConfigurationActionPerformed(evt);
            }
        });
        jMenuConfiguration.add(jMenuItemServerConfiguration);

        jMenuItemDatabaseConfiguration.setText("Database Configuration");
        jMenuItemDatabaseConfiguration.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemDatabaseConfigurationActionPerformed(evt);
            }
        });
    ...
    private void jMenuItemCurrentUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemCurrentUserActionPerformed
        if(theServerThread!=null){
            List<Menadzer> users=theServerThread.getAllUsers();
            CurrentUserForm currentUserForm=new CurrentUserForm(this, true,users);
            currentUserForm.setVisible(true);
        }else{
            JOptionPane.showMessageDialog(this, "Server hasn't been started");
        }
    ...
    private void jMenuItemServerConfigurationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemServerConfigurationActionPerformed
        new ServerConfigurationForm(this, false).setVisible(true);
    }//GEN-LAST:event_jMenuItemServerConfigurationActionPerformed

    private void jMenuItemDatabaseConfigurationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemDatabaseConfigurationActionPerformed
        new DatabaseConfigurationForm(this, false).setVisible(true);
    }//GEN-LAST:event_jMenuItemDatabaseConfigurationActionPerformed
